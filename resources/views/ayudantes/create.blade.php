...
@section('title', 'Registrar Ayudante')
...
<div class="container-fluid">
    <div class="d-flex align-items-center mb-4">
        ...
        <h1 class="h3 mb-0"><i class="fas fa-user-plus me-2 text-primary"></i>Registrar Ayudante</h1>
    </div>

    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('ayudantes.store') }}" method="POST">
                @csrf
                ...
                <div class="d-flex gap-2 border-top pt-3">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-1"></i> Guardar Ayudante
                    </button>
                </div>
            </form>
        </div>
